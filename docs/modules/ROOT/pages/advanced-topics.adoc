...
[source,java]
----
include::example$test/examples/docs/BasicCrudExample.java[tag=insert,indent=0]
----

*Update:*
[source,java]
----
include::example$test/examples/docs/BasicCrudExample.java[tag=update,indent=0]
----

*Delete:*
[source,java]
----
include::example$test/examples/docs/BasicCrudExample.java[tag=delete,indent=0]
----

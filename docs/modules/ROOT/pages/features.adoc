...
*   **Relationship Mapping (`@Link`):** Automatically generates `JOIN` clauses for one-to-one, one-to-many, and many-to-many relationships defined with the `@Link` annotation. Handles simple foreign key conventions and allows customization.

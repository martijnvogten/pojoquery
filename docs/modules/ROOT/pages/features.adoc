...
*   **JPA Annotation Compatibility:** Supports standard JPA annotations (`jakarta.persistence` and `javax.persistence`) as alternatives to PojoQuery's native annotations, allowing existing JPA-annotated entities to work with PojoQuery without modification.

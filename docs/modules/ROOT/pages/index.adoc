...
image::../../_/logo_pojoquery.png[alt="PojoQuery Logo", width=200, height=200]
...
Traditional ORM frameworks like JPA and Hibernate often introduce complexity with features like lazy loading, which can lead to:

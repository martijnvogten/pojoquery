...
class ForeignKeyScanner {
     ...
     */
    static void scanForInferredForeignKeys(TypeModel entityClass, 
        ...
        for (FieldModel field : fields) {
            if (CustomizableQueryBuilder.isListOrArray(field.getType())) {
                ...
                if (componentType != null && CustomizableQueryBuilder.isLinkedClass(componentType)) {
                    ...
                    TypeModel rootTableClass = findRootTableClass(componentType);
     ...
     */
    static TypeModel findRootTableClass(TypeModel clazz) {
